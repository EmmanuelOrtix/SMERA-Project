   ...
   <div class="row">
    <div class="col-md-6">
        <div class="box box-info">
            ...
            <form class="form-horizontal" action="controlador.php?c=usuarios&a=insertar_usuariosAD" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
              	...
              	<div class="form-group">
                    <label class="control-label col-sm-2" for="">Apellido Paterno:</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="email" value="<?php echo $data['usr_apellido_paterno'] ?>"placeholder="ingresa apellido paterno" name="txt_ape_paterno" required="">
                    </div>
                  </div>
            	
              	<div class="form-group">
                    <label class="control-label col-sm-2" for="">Apellido Materno:</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="email" value="<?php echo $data['usr_apellido_materno'] ?>" placeholder="ingresa apellido materno" name="txt_ape_materno" required="">
                    </div>
                  </div>
              	...
              	<div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" value="<?php echo $data['usr_tipo'] ?>" id="" placeholder="ingresa tipo de usuario" name="txt_tipo" required="">
                    </div>
                  </div>
