      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          <li class="dropdown notifications-menu">
            <a href="controlador.php?c=home&a=indexAD">
 ...
 <aside class="main-sidebar">
    <section class="sidebar">
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="controlador.php?c=home&a=indexAD"><i class="fa fa-home"></i> <span>Inicio</span></a></li>
        <li><a href="controlador.php?c=home&a=graficosAD"><i class="fa fa-pie-chart"></i> <span>Indicadores</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
           <!--  <li><a href="#">Opciones de Usuarios</a></li> -->
            <li><a href="controlador.php?c=usuarios&a=home_usuariosAD">Registro de Usarios</a></li>
          </ul>
        </li>
...
<input type="hidden" name="cargar" value="cargar" id="txt_cargar">
