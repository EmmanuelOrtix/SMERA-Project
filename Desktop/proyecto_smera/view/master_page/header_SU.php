      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          <li class="dropdown notifications-menu">
            <a href="controlador.php?c=Home&a=indexSU">
 ...
 <aside class="main-sidebar">
    <section class="sidebar">
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-wrench"></i> <span>Sistema de cobro</span>
      ...
      <li><a href="controlador.php?c=home&a=indexSU"><i class="fa fa-home"></i> <span>Inicio</span></a></li>
      <li><a href="controlador.php?c=home&a=graficosSU"><i class="fa fa-pie-chart"></i> <span>Indicadores</span></a></li>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
           <!--  <li><a href="#">Opciones de Usuarios</a></li> -->
            <li><a href="controlador.php?c=usuarios&a=home_usuarios">Registro de Usarios</a></li>
          </ul>
        </li>
